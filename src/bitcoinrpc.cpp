...
{
    return GetBoolArg("-testnet", false) ? 22404 : 12404;
}
...
Value stop(const Array& params, bool fHelp)
{
    ...
    StartShutdown();
    return "SHREEJI server stopping";
}
...
string HTTPPost(const string& strMsg, const map<string,string>& mapRequestHeaders)
{
    ostringstream s;
    s << "POST / HTTP/1.1\r\n"
      << "User-Agent: shreeji-json-rpc/" << FormatFullVersion() << "\r\n"
      << "Host: 127.0.0.1\r\n"
...
void StartRPCThreads()
{
        ...
        (mapArgs["-rpcuser"] == mapArgs["-rpcpassword"]))
    {
        ...
        string strWhatAmI = "To use shreejid";
